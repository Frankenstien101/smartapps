...
<div class="eod-container">
    ...
    <div class="filter-section no-print">
        ...
        <div class="date-group">
            ...
            <input type="number" id="sodAmount" step="0.01" min="0" placeholder="0.00" style="width:100%;padding:10px 12px;border:1px solid #e2e8f0;border-radius:10px;font-size:13px;">
        </div>
