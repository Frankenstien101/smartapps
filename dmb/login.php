...
if (isset($_POST['login'])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("
            SELECT 
                USERNAME,PASSWORDHASH,ROLE,FULLNAME,BranchName,Gcash
            FROM users
        ...
        if ($user) {
            ...
            if ($user['PASSWORDHASH'] === $password) {
                ...
                $_SESSION['gcash_number'] = $user['Gcash'];

                if ($user['ROLE'] === 'admin') {
                      header("Location: /dmb/home.php");
                } else {
                       header("Location: /dmb/user.php");
                }
...
<html lang="en">
    ...
    <style>
      ...
      * {
      ...
      body {
        ...
        background-image: url('/dmb/mainimg/BG.png');
  ...
  <body>
    ...
    <div class="container">
      <div class="card">
        <div class="logo">
          <img src="/dmb/mainimg/logo.png" alt=" Logo" Style = "height:150px; width:200px">
          <h1>POINT OF SALE</h1>
        </div>
        ...
        <form method="post" action="/dmb/login.php">
