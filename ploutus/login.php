...
if (isset($_POST['login'])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("
            SELECT 
                USERNAME,PASSWORD,ROLE,NAME_OF_USER,SITE,COMPANY,COMPANY_NAME
            FROM USERS
        ...
        if ($user) {
            ...
            if ($user['PASSWORD'] === $password) {
                ...
                if ($user['ROLE'] === 'ADMIN') {
                      header("Location: /ploutus/home.php");
                } else {
                       header("Location: /ploutus/user.php");
                }
...
<html lang="en">
  <head>
    ...
    <style>
      :root {
        --primary: rgb(3, 151, 156);         /* Indigo */
        --primary-light: rgb(3, 108, 134);
        --primary-dark: rgb(2, 96, 112);
      ...
      * {
      ...
      body {
        ...
        background-image: url('/ploutus/mainimg/BG.jpg');
  ...
  <body>
    ...
    <div class="container">
      <div class="card">
        <div class="logo">
          <img src="/ploutus/mainimg/pl.png" alt=" Logo" Style = "height:150px; width:150px">
          <h1>PLOUTUS</h1>
          <p>Secured Accounting Application</p>
        </div>
        ...
        <form method="post" action="/ploutus/login.php">
