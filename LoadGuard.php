...
if (isset($_POST['login'])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("
            SELECT LINEID,USERNAME,PASSWORD,ROLE,FULLNAME,COMPANY, SITE_ID , SITE_NAME
             FROM BS_Users
        ...
        if ($user) {
            ...
            if ($user['PASSWORD'] === $password) {
                ...
                $_SESSION['Name_of_user'] = $user['FULLNAME'];
                ...
                header("Location: LM/Home/portal.php");
...
<html lang="en">
  <head>
    ...
    <style>
      :root {
        --primary: rgb(25, 8, 177);    
        --primary-light: #706903ff;
        --primary-dark: rgb(3, 6, 158);
        --accent: #13087aff;        
        --text: #f8fafc;          
        --text-light: #e2e8f0;
        --text-muted: #94a3b8;
      ...
      * {
      ...
      body {
        ...
        background-image: url('/LM/Home/img/bg.jpg');
      ...
      .nav {
        ...
        align-items: center;
        padding: 1rem 2rem;
        background-color: rgba(42, 5, 179, 0.8);
  ...
  <body>
    ...
    <div class="container">
      <div class="card">
        <div class="logo">
          <img src="\LM\Home\img\LoadGuard2.png" alt="BLUESYS Logo" Style = "height:150px; width:150px">
        </div>
        ...
        <form method="post" action="LoadGuard.php">
    ...
    <div class="footer">
      © <?= date('Y') ?> Load Guard. All rights reserved.
    </div>
  </body>
</html>