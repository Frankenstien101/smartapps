<?php
// pages/accessories.php - Accessories Inventory Page with Images
?>
<style>
...
<div class="accessories-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4><i class="fas fa-headphones"></i> Accessories</h4>
            <p class="text-muted mb-0">Manage your accessories inventory</p>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-plus-circle"></i> Add New Accessory</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label class="form-label">Product Name *</label>
                    <input type="text" id="addProductName" class="form-control" placeholder="e.g., AirPods Pro">
                </div>
                <div class="mb-3">
...
function displayProducts(products) {
    ...
    container.innerHTML = products.map(product => {
        ...
        const imageHtml = hasImage 
            ? `<img src="${product.ProductImagePath}" alt="${escapeHtml(product.ProductName)}" onerror="this.parentElement.classList.add('default-bg'); this.style.display='none'; this.parentElement.innerHTML='<i class=\'fas ${categoryIcon}\'></i>';">`
        ...
        return `
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-brand"><i class="fas fa-tag"></i> ${product.Brand || 'Generic'} | ${product.Category || 'Accessory'}</div>
