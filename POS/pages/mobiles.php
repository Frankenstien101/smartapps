<?php
// pages/mobile-phones.php - Mobile Phones Inventory Page with Images
?>
<style>
...
<div class="mobile-phones-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Manage your mobile phone inventory</p>
        </div>
    </div>
    ...
    <div class="filter-section">
        ...
        <div class="filter-buttons">
            ...
            <button class="filter-btn" data-brand="Google">Google</button>
            <button class="filter-btn" data-brand="Xiaomi">Xiaomi</button>
            <button class="filter-btn" data-brand="Others">Others</button>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">IMEI Number</label>
                        <input type="text" id="editIMEI" class="form-control">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Serial Number</label>
...
async function addProduct() {
    ...
    if (!productName || !brand || sellingPrice <= 0) {
...
async function updateProduct() {
    ...
    if (!productId || !productName || !brand || sellingPrice <= 0) {
        showToast('Please fill in required fields', 'warning');
        return;
    }
...
function filterAndDisplayProducts() {
    ...
    if (currentSearchTerm) {
        filtered = filtered.filter(p => 
            ...
            (p.IMEINumber && p.IMEINumber.toLowerCase().includes(currentSearchTerm)) ||
            (p.SerialNumber && p.SerialNumber.toLowerCase().includes(currentSearchTerm))
        );
    }
...
function getProductImageHtml(product) {
    if (product.ProductImagePath && product.ProductImagePath !== '') {
        ...
        // No image, show default gradient background with icon
...
function displayProducts(products) {
    ...
    container.innerHTML = products.map(product => {
        ...
        const imageHtml = hasImage 
            ? `<img src="${product.ProductImagePath}" alt="${escapeHtml(product.ProductName)}" onerror="this.parentElement.classList.add('default-bg'); this.style.display='none'; this.parentElement.innerHTML='<i class=\'fas fa-mobile-alt\'></i>';">`
        ...
        return `
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    ${product.IMEINumber ? `<div class="product-imei"><i class="fas fa-qrcode"></i> IMEI: ${product.IMEINumber}</div>` : ''}
                    ${product.SerialNumber ? `<div class="product-serial"><i class="fas fa-barcode"></i> Serial: ${product.SerialNumber}</div>` : ''}
...
function openEditModal(productId) {
    ...
    document.getElementById('editProductCategory').value = product.Category || 'Mobile Phones';
    document.getElementById('editIMEI').value = product.IMEINumber || '';
    document.getElementById('editSerial').value = product.SerialNumber || '';
